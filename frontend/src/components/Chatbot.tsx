...
const Chatbot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      sender: 'bot',
      text: "Hi there! I'm the Bhoomi Kart assistant. How can I help you shop sustainably today? Try asking:\n- 'Show me eco-friendly products'\n- 'What's in my cart?'\n- 'Find group buys near me'",
      agent: 'main',
      timestamp: new Date()
    }
  ]);
      ...
      <Drawer anchor="right" open={isOpen} onClose={() => setIsOpen(false)}>
        <Box sx={{ width: 450, height: '100%', display: 'flex', flexDirection: 'column' }}>
          <Paper sx={{ p: 2, bgcolor: 'primary.main', color: 'white', borderRadius: 0 }}>
            <Typography variant="h6">Bhoomi Kart Assistant</Typography>
