    ...
    <footer className="footer">
      ...
      <div className="footer__linkContainer">
        <div className="footer__links">
          ...
          <p className="footer__link">bhoomi Cares</p>
        ...
        <div className="footer__links">
          ...
          <p className="footer__link">Sell on bhoomi</p>
          <p className="footer__link">Sell under bhoomi Accelerator</p>
          <p className="footer__link">bhoomi Global Selling</p>
          <p className="footer__link">Become an Affiliate</p>
          <p className="footer__link">bhoomi Pay on Merchants</p>
          <p className="footer__link">Advertise Your Products</p>
        </div>
        <div className="footer__links">
          <h3 className="footer__linksTitle">Let Us Help You</h3>
          <p className="footer__link">COVID-19 and bhoomi</p>
          ...
          <p className="footer__link">bhoomi App Download</p>
